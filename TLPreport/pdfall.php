...
function BasicTable($header,$actype,$periode)
{
    ...
    //    $this->Cell(40,17,$col,10);
		...
		$this->Cell(275,7,(($actype == "ATR72-600") ? "" :(($actype == "A330-300") || ($actype == "A330-200") || ($actype == "A320-200") || ($actype == "A330") ? "AIRBUS" : (($actype == "CRJ-1000") ? "BOMBARDIER" :  "BOEING")))." ".$judulAC,'LRB',0,'C');
...
function JudulCumulative($header,$actype,$periode,$tinggi,$reghal)
{
    ...
    //    $this->Cell(40,17,$col,10);
		...
		$this->Cell(272,7,(($actype == "A330-300") || ($actype == "A330-200") || ($actype == "A320-200") || ($actype == "A330")? "AIRBUS" : (($actype == "CRJ-1000") ? "BOMBARDIER" : (($actype == "ATR72-600") ? "" : "BOEING")))." ".$judulAC,'LRB',0,'C');
		$this->Ln();
