...
function queryFHapu12($time,$actype,$limit)
{
	if ($actype == "B737-Classic") {
		...
		$qryline = "(`tbl_monthlyapu_util`.`Reg` Like 'PK-GM%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GF%' or `tbl_monthlyapu_util`.`Reg` Like 'PK-GN%')";
	} else {
...
function selectactype() {
	...
	array_push($arractype,"A330","B737-Classic","B737-Classic GA","B737-800-E","B737-800-M");
	return $arractype;
}
